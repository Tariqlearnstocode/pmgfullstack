-- Add Test Transactions for Reports Testing
-- Run this file with: psql -f add_test_transactions.sql or through your Supabase dashboard
...
VALUES 
-- John Doe transactions (tenant_id: 6dd87357-f55a-4020-92d3-97af4baf55ac)
...
-- Sarah Williams transactions (tenant_id: 02404903-db89-4a03-8b2d-f311a1b79764)
INSERT INTO transactions (id, tenant_id, property_id, type_id, amount, date, description, created_at)
VALUES
...
-- Emily Davis transactions (tenant_id: ffdeba4d-dd9b-42c6-9045-1f69e9451200)
INSERT INTO transactions (id, tenant_id, property_id, type_id, amount, date, description, created_at)
VALUES
...
-- Update tenant starting balances
